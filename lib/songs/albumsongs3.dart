...
class AlbumSongs3 extends StatefulWidget {
  const AlbumSongs3({super.key});

  @override
  State<AlbumSongs3> createState() => _AlbumSongs3State();
}

class _AlbumSongs3State extends State<AlbumSongs3> {
  ...
  final _playlst = ConcatenatingAudioSource(children: [
    AudioSource.uri(
      Uri.parse("asset:///songs/kraljboema.mp3"),
      tag: MediaItem(
        id: '1',
        artist: 'Šaban Šaulić',
        album: "Kralj boema veruje u ljubav",
        title: "Kralj boema",
        artUri: Uri.parse(
            "https://i.scdn.co/image/ab67616d0000b273257afbb04e116a92fd84c462"),
      ),
    ),
    AudioSource.uri(
      Uri.parse("asset:///songs/verujemuljubav.mp3"),
      tag: MediaItem(
        id: '2',
        artist: 'Šaban Šaulić',
        album: "Kralj boema veruje u ljubav",
        title: "Verujem u ljubav",
        artUri: Uri.parse(
            "https://i.scdn.co/image/ab67616d0000b273257afbb04e116a92fd84c462"),
      ),
    ),
