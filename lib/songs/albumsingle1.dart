...
class AlbumSingle1 extends StatefulWidget {
  const AlbumSingle1({super.key});

  @override
  State<AlbumSingle1> createState() => _AlbumSingle1State();
}

class _AlbumSingle1State extends State<AlbumSingle1> {
  ...
  final _playlst = ConcatenatingAudioSource(children: [
    AudioSource.uri(
      Uri.parse("asset:///songs/pjesmasamoonjoj.mp3"),
      tag: MediaItem(
        id: '1',
        artist: 'Halid Bešlić',
        album: "Pjesma samo o njoj",
        title: "Pjesma samo o njoj",
        artUri: Uri.parse(
            "https://i.scdn.co/image/ab67616d0000b2735ac1d0d97fe440322d6c7ac9"),
      ),
    ),
  ]);
