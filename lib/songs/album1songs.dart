...
class AlbumSongs1 extends StatefulWidget {
  const AlbumSongs1({super.key});

  @override
  State<AlbumSongs1> createState() => _AlbumSongs1State();
}

class _AlbumSongs1State extends State<AlbumSongs1> {
  ...
  final _playlst = ConcatenatingAudioSource(children: [
    AudioSource.uri(
      Uri.parse("asset:///songs/miljacka.mp3"),
      tag: MediaItem(
        id: '1',
        artist: 'Halid Bešlić',
        album: "Halid 08",
        title: "Miljacka",
        artUri: Uri.parse(
            "https://upload.wikimedia.org/wikipedia/bs/0/09/Halid_08_%28Halid_Be%C5%A1li%C4%87%29.jpg"),
      ),
    ),
    AudioSource.uri(
      Uri.parse("asset:///songs/cardak.mp3"),
      tag: MediaItem(
        id: '2',
        artist: 'Halid Bešlić',
        album: "Halid 08",
    ...
    AudioSource.uri(
      Uri.parse("asset:///songs/netrazime.mp3"),
      tag: MediaItem(
        id: '3',
        artist: 'Halid Bešlić',
        album: "Halid 08",
