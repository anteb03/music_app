...
class AlbumSongs5 extends StatefulWidget {
  const AlbumSongs5({super.key});

  @override
  State<AlbumSongs5> createState() => _AlbumSongs5State();
}

class _AlbumSongs5State extends State<AlbumSongs5> {
  ...
  final _playlst = ConcatenatingAudioSource(children: [
    AudioSource.uri(
      Uri.parse("asset:///songs/vracamsemajciubosnu.mp3"),
      tag: MediaItem(
        id: '1',
        artist: 'Halid Bešlić',
        album: "Otrov",
        title: "Vračam se majci u Bosnu",
        artUri: Uri.parse(
            "https://i.scdn.co/image/ab67616d0000b2737165543c6a6da47dc08a661d"),
      ),
    ),
  ]);
