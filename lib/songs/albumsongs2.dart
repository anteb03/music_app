...
class AlbumSongs2 extends StatefulWidget {
  const AlbumSongs2({super.key});

  @override
  State<AlbumSongs2> createState() => _AlbumSongs2State();
}

class _AlbumSongs2State extends State<AlbumSongs2> {
  ...
  final _playlst = ConcatenatingAudioSource(children: [
    AudioSource.uri(
      Uri.parse("asset:///songs/dasitu.mp3"),
      tag: MediaItem(
        id: '1',
        artist: 'Aco Pejović',
        album: "2010",
        title: "Da si tu",
        artUri: Uri.parse(
            "https://i.scdn.co/image/ab67616d0000b273a1ca72c39c89046360913cfd"),
      ),
    ),
    AudioSource.uri(
      Uri.parse("asset:///songs/nematenema.mp3"),
      tag: MediaItem(
        id: '2',
        artist: 'Aco Pejović',
        album: "2010",
